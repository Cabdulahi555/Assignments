...
int main()
{
  ...
  do {
	...
	switch (answer)
	  ...
	  case 1:
	    S.pop(answer);
	    cout << answer << "  was popped.\n" << endl;
	    S.displayAll();
	    S.Size();
	    break;
	    
	  case 2:
	    cout <<"\nEnter integer to be added: \n ==>";
	    cin >> integer;
	    S.push(integer);
	    cout <<integer << " was added./n" << endl;
	    S.displayAll();
	    S.Size();
	    break;
	  ...
	  case 4:
	    if(S.isFull()){
		  cout <<"\nThe Vector is full. " << endl;
		} else {
		  cout <<"\nVector has room for elements."<< endl;
		}
	    S.displayAll();
	    S.Size();
	    break;
    ...
    //    but do not exit(1) so that you can continue
	      ...
	      {cout <<"Vector has overflowed" << endl;}
	    catch(stack::Underflow)
	      {cout <<"Vector has underflowed" << endl;}
