...
int main()
{
  int X; // local variable to hold deleted elements
  ...
  {
    cout << "Underflow error: cannot delete from empty queue." << endl;
  }
  ...
  {
    cout << "Underflow error: cannot delete from empty L2." << endl;
  }

  // Case 3 lines here (these are your own test cases) -------
  cout << "....Starting case 3..." << endl;

  lqueue L3; //Declare L3
  ...
  L3.deleteFront(X); cout << "removed " << X << endl;
  L3.addRear(40);
  L3.displayAll();
  ...
  {
    cout << "Underflow test confirmed again." << endl;
  }

  cout << "All test cases finished successfully." << endl;
}// end of main
